...
from app.routers import lemmatizer, complexity, profanity, batch_processing, entropy, disambiguator, hybrid_lemma, explain, clarify, simplify, benchmark
...
app.include_router(entropy.router, prefix="/api", tags=["Novel Capabilities"])
app.include_router(disambiguator.router, prefix="/api", tags=["Novel Capabilities"])
app.include_router(hybrid_lemma.router, prefix="/api", tags=["Hybrid Systems"])
app.include_router(explain.router, prefix="/api", tags=["Intelligence Features"])
app.include_router(clarify.router, prefix="/api", tags=["Intelligence Features"])
app.include_router(simplify.router, prefix="/api", tags=["Intelligence Features"])
